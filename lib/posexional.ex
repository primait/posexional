defmodule Posexional do
  ...
  """
  @spec write_file!(Posexional.File.t(), Keyword.t(), binary) :: {:ok, any} | {:error, any}
  ...
  """
  @spec read(Posexional.File.t(), binary) :: Keyword.t()
  ...
  """
  @spec read_file!(Posexional.File.t(), binary) :: Keyword.t()
  def read_file!(file, path) do
    content = File.read!(path)
    read(file, content)
  end

  @spec stream!(Posexional.File.t(), binary) :: any()
